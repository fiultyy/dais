...
Dais is an open, local-first terminal with first-class AI and agent support. Plug in any AI provider, bring in any CLI agent, manage SSH hosts inside the terminal — with keys, history and agent state staying on your machine by default.

## What Dais adds over upstream Warp
...
If you used the project before it was renamed to Dais (formerly **OpenWarp**),
...
- [Warp](https://github.com/warpdotdev/warp) — the upstream terminal Dais is built on.
