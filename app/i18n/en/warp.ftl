...
zap-launch-title = Dais is now open-source
zap-launch-description = You, our community, can participate in building Dais using an agent-first workflow.
zap-launch-contribute-title = Contribute
zap-launch-contribute-description = Dais's client code is now open source. Get started by using the /feedback skill to open an issue, and follow the contribution guidelines here.
zap-launch-contribute-link-text = here
zap-launch-oad-title = Open Automated Development
zap-launch-oad-description = The Dais repo is managed by an agent-first local workflow powered by Oz.
...
keybinding-desc-workspace-open-zap-launch-modal = [Debug] Open Dais Launch Modal
keybinding-desc-workspace-reset-zap-launch-modal-state = [Debug] Reset Dais Launch Modal State
