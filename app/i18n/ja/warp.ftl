...
zap-launch-title = Dais がオープンソースになりました
zap-launch-description = コミュニティの皆さんがエージェントファーストのワークフローで Dais の構築に参加できます。
zap-launch-contribute-title = コントリビュート
zap-launch-contribute-description = Dais のクライアントコードがオープンソースになりました。/feedback スキルで Issue を作成し、こちらのコントリビューションガイドラインに従ってください。
zap-launch-contribute-link-text = こちら
zap-launch-oad-title = Open Automated Development
zap-launch-oad-description = Dais リポジトリは、Oz のローカルエージェント体験を活用したエージェントファーストワークフローで管理されています。
...
keybinding-desc-workspace-open-zap-launch-modal = [Debug] Dais Launch モーダルを開く
keybinding-desc-workspace-reset-zap-launch-modal-state = [Debug] Dais Launch モーダル状態をリセット
