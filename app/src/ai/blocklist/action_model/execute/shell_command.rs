    ...
    pub(super) fn execute(
        ...
        match &input.action.action {
            AIAgentActionType::RequestCommandOutput {
                ...
                // Dais:同步等待型命令(wait_until_completion=true)无条件禁用 pager。
                //
...
/// - 被 Dais generator wrapper 包裹的命令,递归判断内部命令。
