...
impl PassiveSuggestionsModel {
    ...
    fn send_request(
        ...
        log::debug!(
            "[passive-suggestions] skipped MAA request because the multi-agent endpoint is disabled in Dais"
        );
    ...
    fn handle_finished_stream(
        ...
        // Dais:暂时关闭 AgentResponseCompleted 触发的 passive suggestions 云端请求,
