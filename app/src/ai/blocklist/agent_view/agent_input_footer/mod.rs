pub(super) mod chips;
pub mod editor;
// Dais Wave 7-3:`environment_selector` was removed with the hosted-mode footer.
...
// Dais Wave 7-3:`warp_cli::agent::Harness` import was removed with the hosted-mode footer.
...
// Dais Wave 7-3:`EnvironmentSelector` / `EnvironmentSelectorEvent` re-export was removed
...
// Dais Wave 7-3: removed the hosted-mode footer gap constant with the old footer.
...
pub struct AgentInputFooter {
    ...
    // Dais Wave 7-3:`environment_selector` field was removed with the hosted-mode footer.
...
impl AgentInputFooter {
    ...
    pub fn new(
        ...
        // Dais Wave 7-3:`EnvironmentSelector` 初始化 + 订阅 + ambient_agent
        ...
        let mut me = Self {
            ...
            // Dais Wave 7-3:`environment_selector` field init was removed with hosted-mode UI.
            // 子系统物理删。
    ...
    // Dais Wave 7-3: hosted-mode footer rendering was removed.
        ...
        Fut: std::future::Future<Output = Result<(), PluginInstallError>> + Send + 'static,
    {
        ...
        let (shell_path, shell_type) = match shell_data {
            ...
            // needing the Dais plugin to integrate with it.
    ...
    pub fn has_open_chip_menu(&self, app: &AppContext) -> bool {
        // Dais Wave 7-3:`environment_selector` is_menu_open() check was removed with hosted-mode UI.
        // 子系统物理删。
    ...
    pub fn toggle_cli_voice_input(
        ...
        match &self.cli_voice_input_state {
            CLIVoiceInputState::Stopped => {
                // Dais(Phase 3c A1):删除 `AIRequestUsageModel::can_request_voice`
...
impl View for AgentInputFooter {
    ...
    fn render(&self, app: &warpui::AppContext) -> Box<dyn warpui::Element> {
        ...
        // Dais Wave 7-3: removed environment-selector ambient-agent chip injection.
...
pub enum AgentInputFooterEvent {
    ...
    // Dais Wave 7-3:`OpenEnvironmentManagementPane` event was removed with hosted-mode UI.
    // 物理删。
