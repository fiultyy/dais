...
impl RuleView {
    pub fn new(ctx: &mut ViewContext<Self>) -> Self {
        // Dais(本地化,Phase 2d-1):原 UpdateManager 订阅用来接收云端创建/更新的 ack
    ...
    // Dais(本地化,Phase 2d-1):原 `render_sync_status_icon` 依赖 `SyncQueue::is_dequeueing()`
    ...
    fn render_global_rule_row(
        ...
        // Dais(本地化,Phase 2d-1):原 `is_edit_allowed` 依赖网络在线+server_id 两个纬度,
