//! Shimmering Dais loading text - renders Dais logo with shimmering text for loading states.
...
/// Dais icon glyph character
const WARP_GLYPH: &str = "\u{E500}";

/// Creates a shimmering text element with the Dais glyph.
