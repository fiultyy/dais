...
//! depends on the platform. The Dais app must use this information to avoid rendering UI elements
//! underneath them.
...
/// Data the Dais app needs to avoid rendering anything below the traffic lights.
#[derive(Clone, Debug)]
