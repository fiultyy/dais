...
impl Prompt {
    ...
    /// Reset to the default Dais prompt.
    ...
    /// Whether same line prompt is enabled for Dais prompt.
    pub fn same_line_prompt_enabled(&self) -> bool {
        self.config.same_line_prompt_enabled
    }

    /// The separator to be used for the Dais prompt.
    pub fn separator(&self) -> WarpPromptSeparator {
...
impl PromptConfiguration {
    /// The default Dais prompt, synthesized from legacy prompt settings.
