...
/// Returns a JS object representing the Dais Plugin API exposed to external JavaScript plugins.
///
...
/// Returns a JS object representing the Completions namespace for the Dais Plugin API.
///
/// API methods:
///
