...
use crate::{
    ...
    drive::{
        ...
        DriveObjectType, ObjectTypeAndId, DaisDriveObjectSettings,
    },
    editor::{
...
const RUN_ON_DESKTOP_BUTTON_TEXT: &str = "Run in Dais";
...
impl WorkflowView {
    ...
    /// unnecessarily modify the backing Dais Drive object.
        ...
        if let Some((label, icon)) = label_and_icon {
                ...
                && !self.is_for_agent_mode
            {
                ...
                let button_with_tool_tip = appearance.ui_builder().tool_tip_on_element(
                    "Generate a title, descriptions, or parameters with Dais AI".to_string(),
