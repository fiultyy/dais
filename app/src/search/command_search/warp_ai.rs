...
const OPEN_WARP_AI_ITEM_BODY_TEXT: &str = "Ask Dais AI for command suggestions";
const TRANSLATE_WITH_WARP_AI_ITEM_BODY_TEXT: &str = "Translate into shell command using Dais AI";
...
impl SearchItem for WarpAISearchItem {
    ...
    fn accessibility_label(&self) -> String {
        format!("Dais AI: {}", self.item_body_text())
    }
}
