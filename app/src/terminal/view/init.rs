...
pub fn init(app: &mut AppContext) {
    ...
    app.register_editable_bindings([
        ...
        // Dais:删除 terminal:open_share_block_modal keybinding(云端 share block)
        EditableBinding::new(
    ...
    // Dais:删除 terminal:share_current_session / terminal:stop_sharing_current_session keybindings(云端 shared session)
...
fn register_input_mode_bindings(app: &mut AppContext) {
    ...
    // Dais agent should not be tagged into a CLI agent's command, and the
