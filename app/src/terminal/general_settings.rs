...
define_settings_group!(GeneralSettings, settings: [
    show_warning_before_quitting: ShowWarningBeforeQuitting {
        ...
        description: "Whether to show a warning dialog before quitting Dais.",
    },
    quit_on_last_window_closed: QuitOnLastWindowClosed {
        ...
        description: "Whether to quit Dais when the last window is closed.",
    },
    restore_session: RestoreSession {
        ...
        description: "Whether to restore the previous session when Dais starts up.",
    },
    ...
    // One-time flag tracking whether the Dais launch modal has already been
    ...
    did_check_to_trigger_dais_launch_modal: DidShowDaisLaunchModal {
        type: bool,
        default: false,
        supported_platforms: SupportedPlatforms::ALL,
