//! Logic relating to a secondary process which Dais uses to spawn new shell
//! sessions.
//!
...
//! early during Dais's initialization, we can be more confident that there are
...
/// between processes, enabling the Dais application process to communicate
