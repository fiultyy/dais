...
/// The sidebar that houses Dais Drive.
/// `DrivePanel` is different from `DriveIndex` in that it is responsible for
/// how Dais Drive interacts with the workspace and the rest of the app, whereas
/// `DriveIndex` is the main dais drive view and responsible for the internals of Dais Drive.
...
impl DrivePanel {
    ...
    /// This functions scrolls the relevant Dais Drive item into view.
    ...
    /// This functions sets the index of a focused Dais Drive item.
