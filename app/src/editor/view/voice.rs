        ...
        match *source {
            ...
            voice_input::VoiceInputToggledFrom::Key { state } => {
                ...
                match &self.voice_input_state {
                    ...
                    // to Dais and let it go - we should NOT activate voice input in this case.
                    ...
                    // if the user is not focused on Dais (since we lose the ability to listen to modifier
