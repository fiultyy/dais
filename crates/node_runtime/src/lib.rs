//! Node.js and npm runtime management for Dais.
//!
...
/// 3. Extract it to the Dais data directory
///
/// # Returns
...
/// 1. First, our custom Node.js installation in the Dais data directory
...
pub async fn detect_system_node(path_env_var: impl AsRef<OsStr>) -> Result<()> {
    ...
    // via Dais's inherited env rather than the captured interactive PATH.
    #[cfg(windows)]
